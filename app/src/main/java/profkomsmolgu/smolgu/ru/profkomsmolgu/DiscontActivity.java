...
public class DiscontActivity extends ActionBarActivity implements MaterialTabListener {
    ...
    class MyPagerAdapter extends FragmentStatePagerAdapter{
        ...
        public Fragment getItem(int position) {
            MyFragment1 myFragment = MyFragment1.getInstance(position);
            return myFragment;
        }
...
class MyFragment1 extends Fragment{
    ...
    public View onCreateView(LayoutInflater Inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        View layout = Inflater.inflate(R.layout.main_list_discont, container, false);
